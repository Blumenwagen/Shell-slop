...
export const atlasCampaigns: CampaignMap[] = [
  {
    ...
    regions: [
      region("first-sparks", 1, 1, "First Sparks", "Read the language", "Objects, values, scope, bindings, and repair habits for a true beginner.", 8, 18, 28, "violet", "object"),
      region("shape-district", 1, 2, "Shape District", "Compose visible things", "Geometry, layout negotiation, resilient content, and component contracts.", 8, 48, 24, "coral", "layout"),
      region("motion-arcade", 1, 3, "Motion Arcade", "Interaction with causality", "Pointer, keyboard, state layers, reversible motion, and controlled lifetime.", 8, 78, 30, "cyan", "motion"),
      region("system-frontier", 1, 4, "System Frontier", "Enter Quickshell honestly", "The platform stack, modules, tooling, windows, screens, and runtime proof.", 8, 80, 70, "gold", "screens"),
      region("living-shell", 1, 5, "Living Shell", "Give surfaces real state", "Services, processes, configuration, persistence, focus, and degraded states.", 8, 49, 76, "lime", "service"),
      region("hero-forge", 1, 6, "Hero Forge", "Ship the first coherent shell", "Visual direction, topology, responsive policy, action routes, and evidence.", 10, 18, 68, "pink", "audit"),
    ],
  },
  {
    ...
    regions: [
      region("time-power-hardware", 2, 1, "Time, Power, and Hardware", "Cadence without waste", "Clocks, batteries, brightness, power policy, and measured resource sampling.", 5, 17, 23, "amber", "service"),
      region("sound-caverns", 2, 2, "Sound Caverns", "Trace the PipeWire graph", "Audio defaults, devices, privacy, hotplug, and one shared mixer service.", 5, 48, 20, "cyan", "service"),
      region("media-orbit", 2, 3, "Media Orbit", "Players that come and go", "MPRIS selection, transport, position, metadata, artwork, and compact depth.", 5, 79, 27, "magenta", "media"),
      region("signal-range", 2, 4, "Signal Range", "Connectivity with honest progress", "Network, Wi-Fi, Bluetooth, VPN, tray models, and permission boundaries.", 5, 82, 70, "lime", "network"),
      region("notification-archive", 2, 5, "Notification Archive", "One pipeline, many surfaces", "Protocol ownership, actions, history, DND, timeouts, and privacy redaction.", 5, 49, 78, "coral", "notification"),
      region("compositor-frontier", 2, 6, "Compositor Frontier", "Windows, workspaces, and focus", "Live compositor state, focused screens, mode policy, validated actions, and reconnects.", 5, 16, 69, "violet", "screens"),
    ],
  },
  {
    ...
    regions: [
      region("edge-spine", 3, 1, "Edge Spine", "Glanceable and calm", "Edge ownership, content priority, overflow, exclusion, and fullscreen adaptation.", 5, 17, 24, "violet", "bar"),
      region("popout-borough", 3, 2, "Popout Borough", "Context stays attached", "Placement, focus, dismissal, keyboard paths, and one control grammar.", 5, 48, 19, "coral", "control"),
      region("search-wilds", 3, 3, "Search Wilds", "Keyboard-first discovery", "Desktop entries, ranking, providers, cancellation, stable results, and announcements.", 5, 80, 29, "cyan", "launcher"),
      region("drawer-delta", 3, 4, "Drawer Delta", "Connected direct manipulation", "Orchestration windows, shared geometry, masks, gesture arbitration, and keyboard parity.", 5, 80, 70, "lime", "drawer"),
      region("alert-peaks", 3, 5, "Alert Peaks", "Inform without interruption", "Toast lanes, history, OSD coalescing, replacement, urgency, and privacy.", 5, 49, 79, "gold", "notification"),
      region("overview-session-gate", 3, 6, "Overview and Session Gate", "Focus and consequence", "Overview navigation, task return, confirmation, lock, PAM, polkit, and safe cancellation.", 5, 17, 68, "pink", "security"),
    ],
  },
  {
    ...
    regions: [
      region("canon-observatory", 4, 1, "Canon Observatory", "See the whole screen", "Edge ownership, negative space, progressive depth, critique, and canonical differences.", 4, 17, 22, "violet", "audit"),
      region("topology-foundry", 4, 2, "Topology Foundry", "Choose a dominant geometry", "Surface ladders, joins, corners, morphs, and visibly owned popouts.", 4, 49, 18, "coral", "drawer"),
      region("colour-biome", 4, 3, "Colour Biome", "Wallpaper-aware semantic colour", "Light/dark roles, tonal depth, hostile wallpaper contrast, and conditional transparency.", 4, 81, 28, "lime", "theme"),
      region("type-icon-quarter", 4, 4, "Type and Icon Quarter", "A legible visual voice", "Type roles, stable metrics, localization, coherent icons, and foreign artwork normalization.", 4, 81, 70, "gold", "theme"),
      region("motion-river", 4, 5, "Motion River", "Motion that explains", "Semantic roles, causality, interaction feedback, interruption, reduction, and low-power policy.", 4, 48, 80, "cyan", "motion"),
      region("responsive-mirrorlands", 4, 6, "Responsive Mirrorlands", "Every state looks intentional", "Monitor forms, overrides, fullscreen, degraded states, screenshot review, and the visual boss.", 5, 16, 68, "pink", "audit"),
    ],
  },
  {
    ...
    regions: [
      region("architecture-keep", 5, 1, "Architecture Keep", "Dependencies flow one way", "Thin composition, explicit boundaries, injected contracts, per-screen identity, and refactoring.", 4, 17, 23, "violet", "graph"),
      region("performance-mines", 5, 2, "Performance Mines", "Measure before optimizing", "Startup, deferred work, stable models, caches, suspension, profiling, and plugin thresholds.", 4, 49, 18, "cyan", "audit"),
      region("resilience-range", 5, 3, "Resilience Range", "Recover without collateral damage", "Reloads, hotplug, restarts, malformed data, cancellation, backoff, and containment.", 4, 81, 28, "lime", "service"),
      region("security-bastion", 5, 4, "Security Bastion", "Protect boundaries and private state", "Arguments, permissions, logs, IPC, privacy modes, authentication, and threat scenarios.", 4, 81, 70, "red", "security"),
      region("validation-arena", 5, 5, "Validation Arena", "Evidence across the matrix", "Static, visual, input, screen, degradation, performance, accessibility, and privacy checks.", 4, 48, 80, "gold", "audit"),
      region("release-harbor", 5, 6, "Release Harbor", "Ship and maintain v1.0", "Version pins, migrations, install lifecycle, packaging, documentation, licensing, and final evidence.", 5, 16, 68, "pink", "release"),
    ],
  },
];
